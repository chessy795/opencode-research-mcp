...
**Token savings:** It replaces 65 tools from two plugins with 8 tools. The agent spends ~400 tokens browsing tools instead of ~12,000 — most of its context budget goes to research instead of navigating tool menus. This design is grounded in research showing tool catalog size inversely correlates with selection accuracy — well-structured MCP descriptions improve tool selection by +260% (Wang et al. 2026) — and context window grows linearly with tool catalog size (Dunkel 2026).
